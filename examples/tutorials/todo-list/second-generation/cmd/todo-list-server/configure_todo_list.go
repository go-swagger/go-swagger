...
import (
	...
	"github.com/go-swagger/go-swagger/examples/tutorials/todo-list/second-generation/restapi/operations"
	"github.com/go-swagger/go-swagger/examples/tutorials/todo-list/second-generation/restapi/operations/todos"
)
