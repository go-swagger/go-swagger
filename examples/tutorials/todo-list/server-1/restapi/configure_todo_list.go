...
import (
	...
	"github.com/Djarvur/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/Djarvur/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)
