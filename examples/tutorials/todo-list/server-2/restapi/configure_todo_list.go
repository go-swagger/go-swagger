...
import (
	...
	"github.com/eatigo/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/eatigo/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
