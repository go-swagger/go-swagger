...
func (o *AddOneReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewAddOneNoContent creates a AddOneNoContent with default headers values
func NewAddOneNoContent() *AddOneNoContent {
	return &AddOneNoContent{}
}

/*
AddOneNoContent describes a response with status code 204, with default header values.

Already there
*/
type AddOneNoContent struct {
}

// IsSuccess returns true when this add one no content response has a 2xx status code
func (o *AddOneNoContent) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this add one no content response has a 3xx status code
func (o *AddOneNoContent) IsRedirect() bool {
	return false
}

// IsClientError returns true when this add one no content response has a 4xx status code
func (o *AddOneNoContent) IsClientError() bool {
	return false
}

// IsServerError returns true when this add one no content response has a 5xx status code
func (o *AddOneNoContent) IsServerError() bool {
	return false
}

// IsCode returns true when this add one no content response a status code equal to that given
func (o *AddOneNoContent) IsCode(code int) bool {
	return code == 204
}

// Code gets the status code for the add one no content response
func (o *AddOneNoContent) Code() int {
	return 204
}

func (o *AddOneNoContent) Error() string {
	return fmt.Sprintf("[POST /][%d] addOneNoContent", 204)
}

func (o *AddOneNoContent) String() string {
	return fmt.Sprintf("[POST /][%d] addOneNoContent", 204)
}

func (o *AddOneNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
