...
import (
	...
	"github.com/Djarvur/go-swagger/examples/tutorials/custom-server/gen/restapi"
	"github.com/Djarvur/go-swagger/examples/tutorials/custom-server/gen/restapi/operations"
)
