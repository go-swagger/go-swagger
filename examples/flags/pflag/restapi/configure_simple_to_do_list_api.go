...
import (
	...
	"github.com/go-swagger/go-swagger/examples/flags/pflag/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../pflag --name SimpleToDoListAPI --spec ../../swagger.yml --principal any
