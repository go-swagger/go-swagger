...
import (
	...
	"github.com/go-swagger/go-swagger/examples/flags/xflag/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../xflag --name SimpleToDoListAPI --spec ../../swagger.yml --principal any --exclude-spec
