...
func (s *Server) Serve() error {
	...
	log.Printf("serving todo list at unix://%s", s.SocketPath)
	go func() {
	...
	log.Printf("serving todo list at http://%s", listener.Addr())
	go func() {
	...
	log.Printf("serving todo list at https://%s", tlsListener.Addr())
