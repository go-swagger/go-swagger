...
func (o *UploadTaskFileCreated) UploadTaskFileResponder() {}
...
func (o *UploadTaskFileDefault) UploadTaskFileResponder() {}

type UploadTaskFileNotImplementedResponder struct {
	middleware.Responder
}

func (*UploadTaskFileNotImplementedResponder) UploadTaskFileResponder() {}

func UploadTaskFileNotImplemented() UploadTaskFileResponder {
	return &UploadTaskFileNotImplementedResponder{
		middleware.NotImplemented(
			"operation authentication.UploadTaskFile has not yet been implemented",
		),
	}
}

type UploadTaskFileResponder interface {
	middleware.Responder
	UploadTaskFileResponder()
}
