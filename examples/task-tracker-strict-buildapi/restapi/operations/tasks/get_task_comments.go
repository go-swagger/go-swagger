...
type GetTaskCommentsHandlerFunc func(GetTaskCommentsParams) GetTaskCommentsResponder

// Handle executing the request and returning a response
func (fn GetTaskCommentsHandlerFunc) Handle(params GetTaskCommentsParams) GetTaskCommentsResponder {
	return fn(params)
}

// GetTaskCommentsHandler interface for that can handle valid get task comments params
type GetTaskCommentsHandler interface {
	Handle(GetTaskCommentsParams) GetTaskCommentsResponder
}
