...
type UpdateTaskHandlerFunc func(UpdateTaskParams, interface{}) UpdateTaskResponder

// Handle executing the request and returning a response
func (fn UpdateTaskHandlerFunc) Handle(params UpdateTaskParams, principal interface{}) UpdateTaskResponder {
	return fn(params, principal)
}

// UpdateTaskHandler interface for that can handle valid update task params
type UpdateTaskHandler interface {
	Handle(UpdateTaskParams, interface{}) UpdateTaskResponder
}
