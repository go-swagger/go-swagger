...
type CreateTaskHandlerFunc func(CreateTaskParams, interface{}) CreateTaskResponder

// Handle executing the request and returning a response
func (fn CreateTaskHandlerFunc) Handle(params CreateTaskParams, principal interface{}) CreateTaskResponder {
	return fn(params, principal)
}

// CreateTaskHandler interface for that can handle valid create task params
type CreateTaskHandler interface {
	Handle(CreateTaskParams, interface{}) CreateTaskResponder
}
