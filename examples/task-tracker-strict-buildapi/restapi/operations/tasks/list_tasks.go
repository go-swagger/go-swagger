...
type ListTasksHandlerFunc func(ListTasksParams) ListTasksResponder

// Handle executing the request and returning a response
func (fn ListTasksHandlerFunc) Handle(params ListTasksParams) ListTasksResponder {
	return fn(params)
}

// ListTasksHandler interface for that can handle valid list tasks params
type ListTasksHandler interface {
	Handle(ListTasksParams) ListTasksResponder
}
