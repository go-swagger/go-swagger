...
type DeleteTaskHandlerFunc func(DeleteTaskParams, interface{}) DeleteTaskResponder

// Handle executing the request and returning a response
func (fn DeleteTaskHandlerFunc) Handle(params DeleteTaskParams, principal interface{}) DeleteTaskResponder {
	return fn(params, principal)
}

// DeleteTaskHandler interface for that can handle valid delete task params
type DeleteTaskHandler interface {
	Handle(DeleteTaskParams, interface{}) DeleteTaskResponder
}
