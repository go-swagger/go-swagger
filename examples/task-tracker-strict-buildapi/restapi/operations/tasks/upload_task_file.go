...
type UploadTaskFileHandlerFunc func(UploadTaskFileParams, interface{}) UploadTaskFileResponder

// Handle executing the request and returning a response
func (fn UploadTaskFileHandlerFunc) Handle(params UploadTaskFileParams, principal interface{}) UploadTaskFileResponder {
...
type UploadTaskFileHandler interface {
	Handle(UploadTaskFileParams, interface{}) UploadTaskFileResponder
}
