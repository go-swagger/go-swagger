...
type GetTaskDetailsHandlerFunc func(GetTaskDetailsParams) GetTaskDetailsResponder

// Handle executing the request and returning a response
func (fn GetTaskDetailsHandlerFunc) Handle(params GetTaskDetailsParams) GetTaskDetailsResponder {
	return fn(params)
}

// GetTaskDetailsHandler interface for that can handle valid get task details params
type GetTaskDetailsHandler interface {
	Handle(GetTaskDetailsParams) GetTaskDetailsResponder
}
