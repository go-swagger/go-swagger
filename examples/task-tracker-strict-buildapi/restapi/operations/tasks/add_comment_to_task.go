...
type AddCommentToTaskHandlerFunc func(AddCommentToTaskParams, interface{}) AddCommentToTaskResponder

// Handle executing the request and returning a response
func (fn AddCommentToTaskHandlerFunc) Handle(params AddCommentToTaskParams, principal interface{}) AddCommentToTaskResponder {
...
type AddCommentToTaskHandler interface {
	Handle(AddCommentToTaskParams, interface{}) AddCommentToTaskResponder
}
