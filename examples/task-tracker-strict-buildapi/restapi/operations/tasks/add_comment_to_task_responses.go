...
func (o *AddCommentToTaskCreated) AddCommentToTaskResponder() {}
...
func (o *AddCommentToTaskDefault) AddCommentToTaskResponder() {}

type AddCommentToTaskNotImplementedResponder struct {
	middleware.Responder
}

func (*AddCommentToTaskNotImplementedResponder) AddCommentToTaskResponder() {}

func AddCommentToTaskNotImplemented() AddCommentToTaskResponder {
	return &AddCommentToTaskNotImplementedResponder{
		middleware.NotImplemented(
			"operation authentication.AddCommentToTask has not yet been implemented",
		),
	}
}

type AddCommentToTaskResponder interface {
	middleware.Responder
	AddCommentToTaskResponder()
}
