...
func (o *UpdateTaskOK) UpdateTaskResponder() {}
...
func (o *UpdateTaskUnprocessableEntity) UpdateTaskResponder() {}
...
func (o *UpdateTaskDefault) UpdateTaskResponder() {}

type UpdateTaskNotImplementedResponder struct {
	middleware.Responder
}

func (*UpdateTaskNotImplementedResponder) UpdateTaskResponder() {}

func UpdateTaskNotImplemented() UpdateTaskResponder {
	return &UpdateTaskNotImplementedResponder{
		middleware.NotImplemented(
			"operation authentication.UpdateTask has not yet been implemented",
		),
	}
}

type UpdateTaskResponder interface {
	middleware.Responder
	UpdateTaskResponder()
}
