...
// NewIssueTrackerAPI creates a new IssueTracker instance
func NewIssueTrackerAPI(spec *loads.Document) *IssueTrackerAPI {
	return &IssueTrackerAPI{
		...
		TasksAddCommentToTaskHandler: tasks.AddCommentToTaskHandlerFunc(func(params tasks.AddCommentToTaskParams, principal interface{}) tasks.AddCommentToTaskResponder {
		...
		TasksCreateTaskHandler: tasks.CreateTaskHandlerFunc(func(params tasks.CreateTaskParams, principal interface{}) tasks.CreateTaskResponder {
		...
		TasksDeleteTaskHandler: tasks.DeleteTaskHandlerFunc(func(params tasks.DeleteTaskParams, principal interface{}) tasks.DeleteTaskResponder {
		...
		TasksGetTaskCommentsHandler: tasks.GetTaskCommentsHandlerFunc(func(params tasks.GetTaskCommentsParams) tasks.GetTaskCommentsResponder {
		...
		TasksGetTaskDetailsHandler: tasks.GetTaskDetailsHandlerFunc(func(params tasks.GetTaskDetailsParams) tasks.GetTaskDetailsResponder {
		...
		TasksListTasksHandler: tasks.ListTasksHandlerFunc(func(params tasks.ListTasksParams) tasks.ListTasksResponder {
		...
		TasksUpdateTaskHandler: tasks.UpdateTaskHandlerFunc(func(params tasks.UpdateTaskParams, principal interface{}) tasks.UpdateTaskResponder {
		...
		TasksUploadTaskFileHandler: tasks.UploadTaskFileHandlerFunc(func(params tasks.UploadTaskFileParams, principal interface{}) tasks.UploadTaskFileResponder {
...
/*IssueTrackerAPI This application implements a very simple issue tracker.
...
func (o *IssueTrackerAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *IssueTrackerAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *IssueTrackerAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *IssueTrackerAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *IssueTrackerAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *IssueTrackerAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *IssueTrackerAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the IssueTrackerAPI
func (o *IssueTrackerAPI) Validate() error {
...
func (o *IssueTrackerAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *IssueTrackerAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *IssueTrackerAPI) Authorizer() runtime.Authorizer {
...
func (o *IssueTrackerAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *IssueTrackerAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *IssueTrackerAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the issue tracker API
func (o *IssueTrackerAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *IssueTrackerAPI) initHandlerCache() {
...
func (o *IssueTrackerAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *IssueTrackerAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *IssueTrackerAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
