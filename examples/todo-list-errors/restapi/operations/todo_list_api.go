...
func NewTodoListAPI(spec *loads.Document) *TodoListAPI {
	return &TodoListAPI{
		...
		TodosAddOneHandler: todos.AddOneHandlerFunc(func(params todos.AddOneParams) (middleware.Responder, error) {
			_ = params

			return middleware.NotImplemented("operation todos.AddOne has not yet been implemented"), nil
		}),

		TodosDestroyOneHandler: todos.DestroyOneHandlerFunc(func(params todos.DestroyOneParams) (middleware.Responder, error) {
			_ = params

			return middleware.NotImplemented("operation todos.DestroyOne has not yet been implemented"), nil
		}),

		TodosFindHandler: todos.FindHandlerFunc(func(params todos.FindParams) (middleware.Responder, error) {
			_ = params

			return middleware.NotImplemented("operation todos.Find has not yet been implemented"), nil
		}),

		TodosUpdateOneHandler: todos.UpdateOneHandlerFunc(func(params todos.UpdateOneParams) (middleware.Responder, error) {
			_ = params

			return middleware.NotImplemented("operation todos.UpdateOne has not yet been implemented"), nil
		}),
	}
}
