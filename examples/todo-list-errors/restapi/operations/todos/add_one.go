...
type AddOneHandlerFunc func(AddOneParams) (middleware.Responder, error)

// Handle executing the request and returning a response
func (fn AddOneHandlerFunc) Handle(params AddOneParams) (middleware.Responder, error) {
	return fn(params)
}

// AddOneHandler interface for that can handle valid add one params
type AddOneHandler interface {
	Handle(AddOneParams) (middleware.Responder, error)
}
