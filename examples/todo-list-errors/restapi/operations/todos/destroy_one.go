...
type DestroyOneHandlerFunc func(DestroyOneParams) (middleware.Responder, error)

// Handle executing the request and returning a response
func (fn DestroyOneHandlerFunc) Handle(params DestroyOneParams) (middleware.Responder, error) {
	return fn(params)
}

// DestroyOneHandler interface for that can handle valid destroy one params
type DestroyOneHandler interface {
	Handle(DestroyOneParams) (middleware.Responder, error)
}
