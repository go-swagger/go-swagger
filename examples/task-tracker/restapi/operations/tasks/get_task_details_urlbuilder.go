...
func (o *GetTaskDetails) WithBasePath(bp string) *GetTaskDetails {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *GetTaskDetails) SetBasePath(bp string) {
	o._basePath = bp
}
...
func (o *GetTaskDetailsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetTaskDetailsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetTaskDetailsURL")
	}
