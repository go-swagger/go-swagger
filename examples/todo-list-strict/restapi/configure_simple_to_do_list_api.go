...
func configureAPI(api *operations.SimpleToDoListAPIAPI) http.Handler {
	...
	if api.TodosFindHandler == nil {
		api.TodosFindHandler = todos.FindHandlerFunc(func(params todos.FindParams, principal any) todos.FindResponder {
			_ = params
			_ = principal
	...
	if api.TodosUpdateOneHandler == nil {
		api.TodosUpdateOneHandler = todos.UpdateOneHandlerFunc(func(params todos.UpdateOneParams, principal any) todos.UpdateOneResponder {
			_ = params
			_ = principal
