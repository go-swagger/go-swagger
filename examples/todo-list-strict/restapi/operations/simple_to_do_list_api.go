...
func (o *SimpleToDoListAPI) Authorizer() runtime.Authorizer {
...
func (o *SimpleToDoListAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *SimpleToDoListAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
