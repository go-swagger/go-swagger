...
FROM golang:alpine@sha256:2389ebfa5b7f43eeafbd6be0c3700cc46690ef842ad962f6c5bd6be49ed82039 AS build
...
RUN apk update && apk upgrade && apk --no-cache add ca-certificates shared-mime-info mailcap
