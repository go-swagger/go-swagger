...
type PostTodosCreated struct {
	...
	/*
	  In: Body
	*/
	Payload *PostTodosCreatedBody `json:"body,omitempty"`
}
...
func (o *PostTodosCreated) WithPayload(payload *PostTodosCreatedBody) *PostTodosCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the post todos created response
func (o *PostTodosCreated) SetPayload(payload *PostTodosCreatedBody) {
	o.Payload = payload
}
