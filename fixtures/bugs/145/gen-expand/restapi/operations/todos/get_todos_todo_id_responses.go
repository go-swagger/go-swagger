...
type GetTodosTodoIDOK struct {
	...
	/*
	  In: Body
	*/
	Payload *GetTodosTodoIDOKBody `json:"body,omitempty"`
}
...
func (o *GetTodosTodoIDOK) WithPayload(payload *GetTodosTodoIDOKBody) *GetTodosTodoIDOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get todos todo Id o k response
func (o *GetTodosTodoIDOK) SetPayload(payload *GetTodosTodoIDOKBody) {
	o.Payload = payload
}
...
type GetTodosTodoIDNotFound struct {
	...
	/*
	  In: Body
	*/
	Payload *GetTodosTodoIDNotFoundBody `json:"body,omitempty"`
}
...
func (o *GetTodosTodoIDNotFound) WithPayload(payload *GetTodosTodoIDNotFoundBody) *GetTodosTodoIDNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get todos todo Id not found response
func (o *GetTodosTodoIDNotFound) SetPayload(payload *GetTodosTodoIDNotFoundBody) {
	o.Payload = payload
}
...
type GetTodosTodoIDInternalServerError struct {
	...
	/*
	  In: Body
	*/
	Payload *GetTodosTodoIDInternalServerErrorBody `json:"body,omitempty"`
}
...
func (o *GetTodosTodoIDInternalServerError) WithPayload(payload *GetTodosTodoIDInternalServerErrorBody) *GetTodosTodoIDInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get todos todo Id internal server error response
func (o *GetTodosTodoIDInternalServerError) SetPayload(payload *GetTodosTodoIDInternalServerErrorBody) {
	o.Payload = payload
}
