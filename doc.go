...
//
// Treat a specification like any other untrusted input:
// if you obtained it from a remote or untrusted location, review its contents before generating code from it.
//
// To validate a spec:
//
