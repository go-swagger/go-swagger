...
func templatesClientClientGotmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/client/client.gotmpl", size: 2478, mode: os.FileMode(420), modTime: time.Unix(1445186660, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func templatesClientResponseGotmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/client/response.gotmpl", size: 3041, mode: os.FileMode(420), modTime: time.Unix(1445185112, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func templatesSchemavalidatorGotmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/schemavalidator.gotmpl", size: 12487, mode: os.FileMode(420), modTime: time.Unix(1445179382, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
