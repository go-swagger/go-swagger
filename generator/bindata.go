...
func templates_server_parameter_gotmpl() (*asset, error) {
	...
	info := bindata_file_info{name: "templates/server/parameter.gotmpl", size: 7958, mode: os.FileMode(420), modTime: time.Unix(1424420099, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
