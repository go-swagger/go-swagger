...
func TestTemplates_FuncMap(t *testing.T) {
	...
	assert.Contains(t, rendered.String(), `Json={"bytes":"bytes","context":"context","errors":"github.com/go-openapi/errors","io":"io","json":"encoding/json","runtime":"github.com/go-openapi/runtime","strconv":"strconv","swag":"github.com/go-openapi/swag","validate":"github.com/go-openapi/validate"}`)
