...
func jsonschemaDraft04JSON() (*asset, error) {
	...
	info := bindataFileInfo{name: "jsonschema-draft-04.json", size: 4375, mode: os.FileMode(420), modTime: time.Unix(1441639970, 0)}
...
func v2SchemaJSON() (*asset, error) {
	...
	info := bindataFileInfo{name: "v2/schema.json", size: 39976, mode: os.FileMode(420), modTime: time.Unix(1441639970, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
