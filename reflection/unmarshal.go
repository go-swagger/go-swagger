...
// 			return &reflect.ValueError{Method: "reflection.OverflowInt", Kind: target.Kind()}
// 		}
// 		target.SetInt(ev)
// 	default:
...
// 			return &reflect.ValueError{Method: "reflect.Value.OverflowUint", Kind: target.Kind()}
// 		}
// 		target.SetUint(ev)
// 	default:
// 		return fmt.Errorf("Couldn't convert %v (type %T) to int", source.Interface(), source.Interface())
...
// 			return &reflect.ValueError{Method: "reflect.Value.OverflowFloat", Kind: target.Kind()}
// 		}
// 		target.SetFloat(vv)
// 	default:
// 		return fmt.Errorf("Couldn't convert %v (type %T) to int", source.Interface(), source.Interface())
