...
![Google api screenshot](https://github.com/go-swagger/examples/blob/master/oauth2/img/google-api.png)
...
[example_code]: https://github.com/go-swagger/examples/blob/master/oauth2/
