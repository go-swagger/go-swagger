...
Here is an outline of available features (see the full list [here](https://github.com/go-swagger/go-swagger/docs/features.md)):
...
The CLI supports shell autocompletion utilities: see [here](https://github.com/go-swagger/go-swagger/docs/cli_helpers.md).
