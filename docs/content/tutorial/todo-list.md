...
At this point you're able to start the server.

```shellsession
git:(master) ✗ !? » go run ./cmd/todo-list-server/configure_todo_list.go ./cmd/todo-list-server/doc.go ./cmd/todo-list-server/embedded_spec.go ./cmd/todo-list-server/main.go
