...
func TestFormats(t *testing.T) {
	...
	assert.Equal(t, URI("http://somewhereelse.com"), b)
	...
	assert.NoError(t, err)
	assert.Equal(t, Email("somebodyelse@somewhere.com"), b)
	...
	assert.NoError(t, err)
	assert.Equal(t, Hostname("somewhere.com"), b)
	...
	assert.NoError(t, err)
	assert.Equal(t, IPv4("192.168.254.2"), b)
	...
	assert.NoError(t, err)
	assert.Equal(t, UUID3(other3.String()), b)
	...
	assert.NoError(t, err)
	assert.Equal(t, UUID4(other4.String()), b)
	...
	assert.NoError(t, err)
	assert.Equal(t, UUID5(other5.String()), b)
	...
	assert.NoError(t, err)
	assert.Equal(t, UUID(other5.String()), b)
	...
	assert.NoError(t, err)
	assert.Equal(t, ISBN("0836217463"), b)
	...
	assert.NoError(t, err)
	assert.Equal(t, ISBN10("0836217463"), b)
	...
	assert.NoError(t, err)
	assert.Equal(t, ISBN13("0836217462385"), b)
	...
	assert.NoError(t, err)
	assert.Equal(t, HexColor("#000000"), b)
	...
	assert.NoError(t, err)
	assert.Equal(t, RGBColor("rgb(0,0,0)"), b)
	...
	assert.NoError(t, err)
	assert.Equal(t, SSN("999 99 9999"), b)
	...
	assert.NoError(t, err)
	assert.Equal(t, CreditCard("9999-9999-9999-9999"), b)
