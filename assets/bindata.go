...
var _binTree = &binTree{nil, map[string]*binTree{
	"2.0": &binTree{nil, map[string]*binTree{
		"schema.json": &binTree{schema20JSON, map[string]*binTree{}},
	}},
